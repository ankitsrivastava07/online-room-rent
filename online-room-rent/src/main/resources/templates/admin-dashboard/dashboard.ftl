...
<html class="no-js h-100" lang="en">
  ...
  <body class="h-100">
              ...
              <ul class="navbar-nav border-left flex-row ">
                ...
                <li class="nav-item dropdown">
                  ...
                  <div class="dropdown-menu dropdown-menu-small">
                    ...
                    <a class="dropdown-item" href="/admin/add-category">
                  ...
                  <div class="card-body p-0">
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="/admin-ui/images/avatars/1.jpg" alt="User avatar" /> </div>
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="/admin-ui/images/avatars/2.jpg" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
                    ...
                    <div class="blog-comments__item d-flex p-3">
                      <div class="blog-comments__avatar mr-3">
                        <img src="/admin-ui/images/avatars/3.jpg" alt="User avatar" /> </div>
                      <div class="blog-comments__content">
                        <div class="blog-comments__meta text-muted">
                          <a class="text-secondary" href="#">James Johnson</a> on
                          <a class="text-secondary" href="#">Hello World!</a>
    ...
    <script src="/admin-ui/js/dashboard.js"></script>
    ...
    <script src="/admin-ui/scripts/app/app-blog-overview.1.1.0.js"></script>
  </body>
</html>